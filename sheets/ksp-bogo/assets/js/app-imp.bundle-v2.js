(() => {
    ...
    function e() {
        ...
        const t = document.querySelectorAll(".banner-product"),
            ...
            s = document.querySelector(`.product-icon-2:nth-child(${e})`),
            n = {
                1: () => {
        ...
        (window.MkMiracle.ColorSizeSelect = class {
            ...
            existColorHandler(t) {
                const l = $("input[name='fabric_type']:checked").val(),
                    ...
                    n = Object.keys(this.variants[l][$(".quantity_input").val().toString()][s]).slice(-1)[0],
                    o = $(`[data-color="${n}"]`)[0],
                    i = o.dataset.slide;
                    console.log(l)
                o.click(), e(i);
            ...
            existSizeHandler(t) {
                const l = $("input[name='fabric_type']:checked").val(),
                    ...
                    n = s.data("slide"),
                    o = s.data("color");
                for (const [e, t] of Object.entries(this.variants[l][$(".quantity_input").val().toString()]))
                    if (t[o]) {
