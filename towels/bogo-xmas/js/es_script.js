jQuery(document).ready(function($) {
	const variants = {
    /*
    stone: { variantId: 37064720973974, name: 'Black Friday - Towel Bundle - 1 Towel Bundle / Stone', productTitle: '1 Towel Bundle / Stone', price: 45, regularPrice: 90, productSavings: 20, productReviews: 565, imgUrl: 'images/Towel_Bogo_Desktop_Stone--', mobimgUrl: 'images/Towel_Bogo_Desktop_Stone--', sku:"bf-bundle-stone-1" },
    */
