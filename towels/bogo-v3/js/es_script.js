jQuery(document).ready(function($) {
	const variants = {
    /*
    stone: { variantId: 37064720973974, name: 'Black Friday - Towel Bundle - 1 Towel Bundle / Stone', productTitle: '1 Towel Bundle / Stone', price: 45, regularPrice: 80, productSavings: 20, productReviews: 565, imgUrl: 'images/Towel_Bogo_Desktop_Stone', mobimgUrl: 'images/Towel_Bogo_Mobile_Stone', sku:"bf-bundle-stone-1" },
    */
    white: { variantId: 37064721006742, name: 'Black Friday - Towel Bundle - 1 Towel Bundle / White', productTitle: '1 Towel Bundle / White', price: 45, regularPrice: 80, productSavings: 20, productReviews: 565, imgUrl: 'images/Towel_Bogo_Desktop_White', mobimgUrl: 'images/Towel_Bogo_Mobile_White', sku:"bf-bundle-white-1"  },
    // bundle_2: {
    ...
    // },
    checkouturl : "https://try.miraclebrand.co/checkout/t_b"
	};
    ...
    function selVariant() {
        ...
        $(".es_product-image").attr("src", variants[color]['imgUrl'] + qty + ".png");
        $(".es_product-image_mob").attr("src", variants[color]['mobimgUrl'] + qty + ".png");
        $(".bundle_cnt").text(qty);
    }
