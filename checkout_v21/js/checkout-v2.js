...
let checkoutHench = {
	...
	toggleOrderSummary: function() {
		const trigger = document.querySelector('.reveal-handler');
		const mobileSummary = document.querySelector('.mobile-order-summary-box');
		trigger.addEventListener('click', function(e) {
			mobileSummary.classList.toggle('revealed');
		});
	},
