jQuery(document).ready(function ($) {
	...
	*/
	...
	function selVariant() {
		...
		var size = $('.fabric-selector-wrapper .w--redirected-checked').attr("data-size");
	...
	function filterSizeSwatches(color) {
		...
		size = $('.fabric-selector-wrapper .w--redirected-checked').attr("data-size");
	...
	$(document).on("change", ".fabric-select-wrapper", function() {
	...
	$(".quantity-sc .btn-quantity_plus").click(function (e) {
		var qty = parseInt($(".quantity .quantity_input").val());
		$(".quantity-sc .quantity_input").val(qty + 1);;
	});

	$(".quantity-sc .btn-quantity_minus").click(function (e) {
		var qty = parseInt($(".quantity .quantity_input").val());
		if (qty <= 1) {
			return;
		}
