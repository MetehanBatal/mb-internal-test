jQuery(document).ready(function($) {
    ...
    window.checkoutReadyCallbacks.push(() => {
    	...
    	$(".size-choice").click(function(e) {
			...
			if(activeEl === "king") {
				$(".color.stone-color.color-choice.sold").removeClass("sold");
			}else {
				$(".color.stone-color.color-choice").addClass("sold");
			}
    	});
		/* Color selection function. Active Class for colorful border */
    	$(".color-choice").click(function(e) {
			if(!e.currentTarget.classList.contains("white-color")) {
				$("label[data-size='queen']").addClass("sold-size");
			}else {
				$("label[data-size='queen']").removeClass("sold-size");
			}
    		// var wrapper = $(this).parents(".size-container");
